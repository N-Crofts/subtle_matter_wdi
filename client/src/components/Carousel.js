...
export default class SubtlePages extends React.Component {
                ...
                <div style={{ height: 570 }}>
                  <div class="text-shadow-drop-bl" style={insideStyles}>
                    <div class="text-focus-in">
                      ...
                      <a href="#scrollOne">
                        <img id="button" className="blink" src="http://icons-for-free.com/icon/download-tik_icon-381203.png" alt="golden ratio"></img>
                      </a>
                      </p> 
                      <p>My awareness burst, swarming outward in all directions. So unknown and intriguing; a knocking of hoof against cobblestone. Still far off, its quick approach would incite my first brush with fear. In just moments, though, the noise passed, trailing off, and although I had just been afraid, I found myself stung by a sudden loneliness, and I begged for that tingling rattle to find its way back to me. I hadn't eyes to witness, no voice to call out to it. Even today I'm still unsure as to what sort of miracle allowed me to take in the clamor of the world around me, or why I was given this gift before any other. Maybe it was nature's way of conditioning me, preparing me for the burden to come.
  ...
  <source src={unlock} />
        ...
        <div style={picInsideRight}>
            <img class="storyImageLight" id="imageThree" src="https://ksr-ugc.imgix.net/assets/005/319/411/af8a1e4706417fb4ff116f523217efbc_original.jpg?ixlib=rb-1.1.0&w=680&fit=max&v=1454844185&auto=format&gif-q=50&q=92&s=16fbdeda383a43c1f46c92897bff04bb" alt="golden ration"></img>
      ...
      <div style={{ height: 800 }}>
       ...
       <div class="slide">
        ...
        <div style={picInsideLeft}>
            <img class="storyImageLight" id="imageFour" src="http://static.wixstatic.com/media/9b7452_39630b3912624c4c9951f143c3f6a07e.jpg/v1/fill/w_629,h_747,al_c,q_85,usm_0.66_1.00_0.01/9b7452_39630b3912624c4c9951f143c3f6a07e.webp" alt="golden ration"></img>
        </div>
        </div>
      </div>
      </Carousel.Item>
       ...
       <div style={{ height: 700 }}>
        ...
        <div style={picInsideLeft}>
            <img class="storyImageDark" id="imageFive" src="http://copadirecta.me/wp-content/uploads/2018/05/golden-ratio-coloring-book-rafael-araujo-artist-golden-ratio-colouring-book-rafael-araujo.jpg" alt="golden ration"></img>
        </div>
      </div>
        </Carousel.Item>
...
<div style={{ height: 700 }}>
        ...
        <div style={picInsideRight}>
            <img class="storyImageDark" id="imageSix" src="http://mediad.publicbroadcasting.net/p/kplu/files/styles/medium/public/201510/Energy-Spiral.jpg" alt="golden ration"></img>
        </div>
...
<div style={{ height: 800 }}>
        ...
        <div style={picInsideLeft}>
            <img class="storyImageDark" id="imageSeven" src="https://pbs.twimg.com/media/CfWV0-XWAAAAe0n.jpg" alt="golden ration"></img>
        </div>
      </div>
</Carousel.Item>
...
<div style={{ height: 700 }}>
        ...
        <div style={picInsideRight}>
            <img class="storyImageDark" id="imageEight" src="https://havenspoint.weebly.com/uploads/2/5/9/4/25947026/4d0e0a490e809f4f2dbf95c25e2ee235_orig.jpg?235" alt="golden ration"></img>
        </div>
      </div>
</Carousel.Item>
