        ...
        for(let i = 0; i < videos.length; i++) {   
            ...
            let visible    
                ...
                visible = visibleX * visibleY / (w * h); 
                  ...
                  if ((visible > 0.8) && (video.played.length === 0)) {
                    console.log('PLAYING')
                    video.play();
                  } 
                  //   else {
...
export default class StoryPage extends Component {
    ...
    <Parallax bgImage={image3} strength={500}>
      <div style={{ height: 500 }}>
          <div class="text-shadow-drop-bl" style={rightStyles}>
            ...
            <ScrollAnimation delay={1000} animateIn="fadeIn" animateOut='fadeOut'>       
        ...
        <div style={picInsideLeft}>
            <ScrollAnimation delay={750} animateIn="rotateInUpLeft" animateOut='fadeOut'>
            <img class="storyImageLight" src="https://images.fastcompany.net/image/upload/w_596,c_limit,q_auto:best,f_auto/fc/3058744-inline-8-the-golden-ratio-gets-its-own-coloring-book.jpg" alt="golden ration"></img>
            </ScrollAnimation>           
        </div>
      </div>
    </Parallax>
    
    <Parallax id="crunk" bgImage={image2} strength={-100}>
      <div style={{ height: 500 }}>
        ...
        <ScrollAnimation delay={500} animateIn="fadeIn" animateOut='fadeOut'>
            ...
            <ScrollAnimation delay={1000} animateIn="fadeIn" animateOut='fadeOut'>       
            <p>We begin with a sound. That's all. A simple repetition. And I awoke to meet it. My awareness burst, swarming outward in all directions. So unknown and intriguing; a knocking of hoof against cobblestone. Still far off, its quick approach would incite my first brush with fear. In just moments, though, the noise passed, trailing off, and although I had just been afraid, I found myself stung by a sudden loneliness, and I begged for that tingling rattle to find its wayback to me. I hadn't eyes to witness, no voice to call out to it. Even today I'm still unsure as to what sort of miracle allowed me to take in the clamor of the world around me, or why I was given this gift before any other. Maybe it was nature's way of conditioning me, preparing me for the burden to come.</p>
            </ScrollAnimation> 
        </div>
      </div>
    </Parallax>
  ...
  <source src={horse} />
        ...
        <Parallax bgImage={image3} strength={500}>
      <div class="minutesPassed" style={{ height: 700 }}>
        ...
        <div style={picInsideRight}>
            ...
            <img class="storyImageLight" src="https://ksr-ugc.imgix.net/assets/005/319/411/af8a1e4706417fb4ff116f523217efbc_original.jpg?ixlib=rb-1.1.0&w=680&fit=max&v=1454844185&auto=format&gif-q=50&q=92&s=16fbdeda383a43c1f46c92897bff04bb" alt="golden ration"></img>
            </ScrollAnimation>           
        </div>
      </div>
    </Parallax>
  ...
  <source src={unlock} />
    ...
    {/* <video id="video">
  <source src="http://soundimage.org/wp-content/uploads/2017/03/Interior-Door_Unlock.mp3" />
</video> */}
      ...
      <div style={{ height: 900 }}>
        ...
        <div style={picInsideLeft}>
            <img class="storyImageLight" src="http://static.wixstatic.com/media/9b7452_39630b3912624c4c9951f143c3f6a07e.jpg/v1/fill/w_629,h_747,al_c,q_85,usm_0.66_1.00_0.01/9b7452_39630b3912624c4c9951f143c3f6a07e.webp" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
    ...
    <Parallax bgImage={image2} strength={-100}>
      <div style={{ height: 950 }}>
        ...
        <div style={picInsideLeft}>
            <img class="storyImageDark" src="http://copadirecta.me/wp-content/uploads/2018/05/golden-ratio-coloring-book-rafael-araujo-artist-golden-ratio-colouring-book-rafael-araujo.jpg" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
      ...
      <div style={{ height: 500 }}>
        ...
        <p>“What chemicals, you fool!”</p>
            <p>Mr. Adler yelled. His sound no longer melodic, no longer soothing to me. Though at the time I couldn’t fully comprehend the point of their discussion, their emotions were exceptionally clear. Mr. Hoyt was frantic, desperate. It was clear that things hadn’t gone the way he had hoped. Mr. Adler soon let out another sound, something strange and chaotic, something not following the ebb and flow of words. I would eventually come to know it as laughter. And even though laughter should signify joy, it can also be used as mockery, as a verbal hammer against the dreams of its target.</p>
            <p>“All you have, Hoyt, are scraps of metal and copper wires you’ve bombarded with electric currents. There are no observable reactions to speak of.” Adler stormed away. The door creaked open. “I wish you’d have told me what was so enchanting to you before I bothered to come down here. Nevertheless, you’ve given me a good laugh today, Hoyt. I can’t wait to share this little discovery of yours with more serious academians.” He mumbled something else as the door slammed shut.</p>
        </div>
      </div>
    </Parallax>
    ...
    <Parallax bgImage={image2} strength={-100}>
      <div style={{ height: 500 }}>
        <div class="text-shadow-drop-bl" style={leftStyles}>
            ...
            <p>At last I heard a shuffling over to me. He knelt close and sighed. His breath tingled, warm currents of air pushed against me. “I‘m no fool,” he whispered. “But perhaps he was right. After all, growing children need sustenance, wouldn‘t you agree?”</p>
        </div>
        <div style={picInsideRight}>
            <img class="storyImageDark" src="http://mediad.publicbroadcasting.net/p/kplu/files/styles/medium/public/201510/Energy-Spiral.jpg" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
    ...
    <Parallax bgImage={image2} strength={-100}>
      <div style={{ height: 500 }}>
        <div class="text-shadow-drop-bl" style={rightStyles}>
            <p>And then, like an answer to my voiceless prayer, Mr. Hoyt arrived one evening carrying something intriguing, something that clanked and clattered in the loveliest of ways. He huffed as he dropped a container onto the table next to me and began unloading its contents. He flipped on his resonant transformer, feeding me with that electric tingle I usually enjoyed.</p>
            ...
            <p>He stepped back and paused, regarding me, I suppose, then giggled and made his way to the door. He shut it gently as he left me for the night.</p>
        </div>
        <div style={picInsideLeft}>
            <img class="storyImageDark" src="https://pbs.twimg.com/media/CfWV0-XWAAAAe0n.jpg" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
      ...
      <div style={{ height: 500 }}>
        <div class="text-shadow-drop-bl" style={insideStyles}>
            ...
            <p>And then . . .</p>
            <p><i>Could it be?</i></p>
            <p>Morning had come. The gift of sight may have found me in the dark, but it wasn’t until sunlight flooded in through the eastern window that I saw the room for the first time with my incredible new eye.</p>
    ...
    <Parallax bgImage={image2} strength={-100}>
      <div style={{ height: 750 }}>
        ...
        <div style={picInsideRight}>
            <img class="storyImageDark" src="https://havenspoint.weebly.com/uploads/2/5/9/4/25947026/4d0e0a490e809f4f2dbf95c25e2ee235_orig.jpg?235" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
      ...
      <div style={{ height: 700 }}>
        <div class="text-shadow-drop-bl" style={insideStyles}>
            ...
            <p>Late one evening, during autumn’s most relentless thunderstorm——Mr. Adler returned.</p>
        </div>
      </div>
    </Parallax>
    ...
    <Parallax bgImage={image2} strength={-100}>
      <div style={{ height: 500 }}>
        ...
        <div style={picInsideLeft}>
            <img class="storyImageDark" src="http://static.wixstatic.com/media/9b7452_a58f1c8d805e49438af63a42c36e68da.jpg/v1/fill/w_629,h_441,al_c,q_80,usm_0.66_1.00_0.01/9b7452_a58f1c8d805e49438af63a42c36e68da.webp" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
    ...
    <Parallax bgImage={image3} strength={500}>
      <div style={{ height: 600 }}>
        <div class="text-shadow-drop-bl" style={leftStyles}>
            <p>Outside, thunder rolled; a downpour followed. The rain against my body sizzled and crackled as wires popped and extinguished. With my one arm around the neck and shoulder of my</p>
            <p>caregiver, I hung on as he climbed the wrought iron ladder outside his townhouse, making our way to the roof.</p>
        ...
        <div id="shadow-drop-2-center" style={picInsideRight}>
            <img class="storyImageLight" src="https://i2.wp.com/blogs.ams.org/blogonmathblogs/files/2018/01/9b7452_72207676f6684f0ca5655340f5f868b7.jpg?resize=493%2C507" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
    ...
    <Parallax bgImage={image2} strength={-100}>
      <div style={{ height: 650 }}>
        ...
        <div style={picInsideLeft}>
            <img class="storyImageDark" src="https://i.pinimg.com/originals/57/a8/44/57a844090e72b14fe41317a5f9d6f4b8.jpg" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
    ...
    <Parallax bgImage={image2} strength={-100}>
      <div style={{ height: 820 }}>
        ...
        <div style={picInsideRight}>
            <img class="storyImageDark" src="https://images.curiator.com/images/t_x/art/e89a481c19e67f6c6c33dc3a4ebbd072/rafael-araujo-shell-2004.jpg" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
    ...
    <Parallax bgImage={image2} strength={-100}>
      <div style={{ height: 550 }}>
        ...
        <div style={picInsideLeft}>
            <img class="storyImageDark" src="http://archive.naplesnews.com/images.ashx?file=us_news_attack-savant_2_tc_6893577_ver1.0_640_480.jpg&resize=" alt="golden ration"></img>
        </div>
      </div>
    </Parallax>
      ...
      renderLayer={percentage => (
        <div>
          <div
            style={{
              position: "absolute",
              background: `rgba(16, 16, 16, ${percentage * 1})`,
              left: "50%",
              top: "50%",
              borderRadius: "50%",
              transform: "translate(-50%,-50%)",
